...
bw2data.egg-info/entry_points.txt
...
bw2data/backends/iotable/__init__.py
bw2data/backends/json/__init__.py
bw2data/backends/json/database.py
bw2data/backends/json/mapping.py
bw2data/backends/json/proxies.py
bw2data/backends/json/sync_json_dict.py
bw2data/backends/peewee/__init__.py
bw2data/backends/peewee/database.py
bw2data/backends/peewee/proxies.py
bw2data/backends/peewee/schema.py
bw2data/backends/peewee/utils.py
bw2data/backends/single_file/__init__.py
bw2data/backends/single_file/database.py
bw2data/backends/single_file/proxies.py
bw2data/bin/__init__.py
bw2data/bin/bw2_uptodate.py
...
tests/geo.py
tests/ia.py
tests/json_database.py
tests/naughty_strings.txt
tests/parameters.py
tests/projects.py
tests/search.py
tests/serialization.py
tests/single_file_database.py
tests/sqlite.py
tests/updates.py
tests/utils.py
tests/validation.py